...
np = getPathClass('Granulocyte')
np.setColor(Color.BLUE.getRGB())
inf = getPathClass('Lymphocyte')
inf.setColor(Color.GREEN.getRGB())
con = getPathClass('Plasme')
con.setColor(Color.CYAN.getRGB())
dead = getPathClass('Tumor')
dead.setColor(Color.RED.getRGB())
nne = getPathClass('Stroma')
nne.setColor(Color.MAGENTA.getRGB())
